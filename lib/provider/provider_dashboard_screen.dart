...
class ProviderDashboardScreenState extends State<ProviderDashboardScreen> {
  ...
  Future<void> init() async {
    ...
    LiveStream().on(LIVESTREAM_PROVIDER_ALL_BOOKING, (index) {
      appStore.dashboardIndex = index as int;
      setState(() {});
    });
      ...
      child: Observer(
        builder: (BuildContext context) {
          return Scaffold(
                  ...
                  icon: Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        right: -6,
                        child:
                           appStore.notificationCount.validate() > 0 ?
                               Container(
            ...
            body: fragmentList[appStore.dashboardIndex],
                ...
                child: Observer(
                  builder: (BuildContext context) {
                    return NavigationBar(
                      selectedIndex: appStore.dashboardIndex,
                      destinations: [
                        ...
                        NavigationDestination(
                          ...
                          selectedIcon: Image.asset(chat, height: 20, width: 20, color: primaryColor),
