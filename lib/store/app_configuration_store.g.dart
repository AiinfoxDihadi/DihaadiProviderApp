...
mixin _$AppConfigurationStore on _AppConfigurationStore, Store {
  ...
  late final _$autoAssignStatusAtom =
      Atom(name: '_AppConfigurationStore.autoAssignStatus', context: context);
  ...
  late final _$setAutoAssignStatusAsyncAction = AsyncAction(
      '_AppConfigurationStore.setAutoAssignStatus',
      context: context);

  @override
  Future<void> setAutoAssignStatus(bool val) {
    return _$setAutoAssignStatusAsyncAction
        .run(() => super.setAutoAssignStatus(val));
  }
