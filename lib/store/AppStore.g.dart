...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$dashboardIndexAtom =
      Atom(name: '_AppStore.dashboardIndex', context: context);

  @override
  int get dashboardIndex {
    _$dashboardIndexAtom.reportRead();
    return super.dashboardIndex;
  }

  @override
  set dashboardIndex(int value) {
    _$dashboardIndexAtom.reportWrite(value, super.dashboardIndex, () {
      super.dashboardIndex = value;
    });
  }
  ...
  late final _$bankProfileImageAtom =
      Atom(name: '_AppStore.bankProfileImage', context: context);

  @override
  String get bankProfileImage {
    _$bankProfileImageAtom.reportRead();
    return super.bankProfileImage;
  }

  @override
  set bankProfileImage(String value) {
    _$bankProfileImageAtom.reportWrite(value, super.bankProfileImage, () {
      super.bankProfileImage = value;
    });
  }
  ...
  void setIndex(int index) {
    final _$actionInfo =
        _$_AppStoreActionController.startAction(name: '_AppStore.setIndex');
    try {
...
bankProfileImage: ${bankProfileImage},
